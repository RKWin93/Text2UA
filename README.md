...
% ![System architecture](./Assets/archi.png){ width=80px height=80px }
<img src="./Assets/archi.png" width="80" height="80" alt="System architecture">


## System model of MT-FJSP
![System model](./Assets/model.png){width=80px height=80px }
